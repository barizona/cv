...
-   Első-, utolsó- vagy levelezőszerzős publikációk száma: **`r {{ pub_tab$Nr_firs_last_author[1] }}`**
-   Első-, utolsó- vagy levelezőszerzős publikációk összesített impakt faktora (IF): **`r {{ pub_tab$IF_firs_last_author[1] }}`**
